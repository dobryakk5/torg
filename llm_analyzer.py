...
- ПРОПУСТИТЬ ставь только при жёстких блокерах: лицензии ФСТЭК/ФСБ/СРО; обязательное
  партнёрство или сертификация вендора; регулярное физическое присутствие на объекте;
  чистый перекуп лицензий/железа без работ; в проект контракта уже вписан конкретный
  исполнитель (закупка под него); жёсткий SLA при чистой поддержке.
...
партнёра, лицензии ФСТЭК/ФСБ/СРО, вписанный исполнитель, физическое присутствие,
жёсткий SLA. Каждый — одной строкой «- <суть>». Если их нет — ровно одна строка «- нет»)
- ...
